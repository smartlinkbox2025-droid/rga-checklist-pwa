const CACHE='checklist-enterprise-v3-final';
const ASSETS=['./','./index.html','./assets/styles.css','./assets/app.js','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg'];
